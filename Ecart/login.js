  ...
  fetch("https://fakestoreapi.com/products")
    ...
    .then((data) => {
      ...
      if (localStorage.getItem("Itemid") != null) {
        ...
        // console.log("length1" + Nitem.length + "items " + Nitem);
...
function cartitem(id) {
  ...
  let items = item.flat(Infinity);
  console.log("items length to be added" + items.length);
...
window.addEventListener("load", (event) => {
  ...
  if (Sitems != null) {
    ...
    console.log("FRAMES TO BE ADDED" + frames);
